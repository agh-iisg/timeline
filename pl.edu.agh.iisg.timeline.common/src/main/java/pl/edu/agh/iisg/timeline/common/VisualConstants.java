package pl.edu.agh.iisg.timeline.common;
...
import pl.edu.agh.iisg.timeline.common.util.FontsLoader;
...
public final class VisualConstants {
    ...
    public static final Font AXIS_FONT = new Font(Display.getDefault(), "Franklin Gothic Demi", 10, SWT.NONE); //$NON-NLS-1$
    ...
    public static final Font SEPARATOR_FONT = new Font(Display.getDefault(), "Franklin Gothic Demi", 9, SWT.NONE); //$NON-NLS-1$
    ...
    public static final Font ELEMENT_TITLE_FONT = new Font(Display.getDefault(), "Franklin Gothic Demi", 10, SWT.NONE); //$NON-NLS-1$
    ...
    public static final Font ELEMENT_DESC_FONT = new Font(Display.getDefault(), "Franklin Gothic Book", 10, SWT.NONE); //$NON-NLS-1$

    public static final int ELEMENT_DESC_CHARS_PER_LINE = 48;

    public static final int ELEMENT_MARGIN = 4;

    private static final String FONT_DIR = "fonts"; //$NON-NLS-1$
