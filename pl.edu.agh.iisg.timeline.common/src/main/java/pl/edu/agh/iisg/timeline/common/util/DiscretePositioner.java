...
public class DiscretePositioner implements IPositioner {
    ...
    public static final int SEPARATOR_GAP = pl.edu.agh.iisg.timeline.common.VisualConstants.SEPARATOR_MARGIN_TOP_BOTTOM + VisualConstants.SEPARATOR_HEIGHT;
        ...
        for (Entry<Calendar, Collection<Element>> entry : elementsByPeriod.asMap().entrySet()) {
            ...
            for (Element element : elements) {
                ...
                int spaceForElement = measurer.getHeightOf(element) + VisualConstants.ELEMENT_MARGIN
                        + pl.edu.agh.iisg.timeline.common.VisualConstants.ELEMENT_SQUARE_MARGIN;
