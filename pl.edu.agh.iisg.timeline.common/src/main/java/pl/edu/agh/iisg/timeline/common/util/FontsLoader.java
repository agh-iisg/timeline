...
import pl.edu.agh.iisg.timeline.common.Activator;
...
public class FontsLoader {
    ...
    public static void loadFromDirectory(String relativeDir) throws IOException {
        ...
        if (!fontsDir.isDirectory()) {
            throw new IllegalArgumentException("Fonts should be loaded from directory given as plugin relative path"); //$NON-NLS-1$
        }
